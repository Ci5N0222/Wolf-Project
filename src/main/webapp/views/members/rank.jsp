...
<body>
	<div class="container-fluid d-flex flex-column">
        ...
        <div class="btn-group mb-4">
            <button type="button" class="btn btn-primary mr-2" onclick="loadRank(6)">Among_Run</button>
            <button type="button" class="btn btn-primary mr-2" onclick="loadRank(8)">FlyingBird</button>
            <button type="button" class="btn btn-primary mr-2" onclick="loadRank(9)">MashimaroJump</button>
            <button type="button" class="btn btn-primary mr-2" onclick="loadRank(10)">RoadKill</button>
            <button type="button" class="btn btn-primary" onclick="loadRank(11)">SpaceFlight</button>
        </div>
