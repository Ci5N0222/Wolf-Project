...
<div class="row g-4 my-0 navi">
	<div class="col-4 d-flex justify-content-start">
		<div class="d-flex flex-row">
			...
			<div class="me-3 naviBtn"
				onclick="location.href='/views/members/rank.jsp'">Ranking</div>
		</div>
	</div>
		...
		<c:if test="${WolfID == null}">
			...
			<div>
				<button class="btn btn-primary"
					onclick="location.href='/views/members/login.jsp'">Sign-In</button>
				<button class="btn btn-primary"
					onclick="location.href='/views/members/signup.jsp'">Sign-Up</button>
			</div>
		</c:if>
		<c:if test="${ WolfID != null }">
			<div>
			...
			<div>
				<button class="btn btn-primary"
					onclick="location.href='/logout.members'">Sign-Out</button>
			</div>
		</c:if>
	</div>
...
<nav class="navbar navbar-dark fixed-top m_navi">
	<div class="container-fluid" style="padding: 0 15px;">
		...
		<c:if test="${WolfID == null}">
			<div class="naviBtn loginBtn" data-bs-toggle="offcanvas"
		...
		<div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1"
			...
			<div class="offcanvas-body">
				<ul class="navbar-nav">
					...
					<li class="nav-item"
						onclick="location.href='/views/members/rank.jsp'">
						<div>
					...
					<c:if test="${WolfID != null}">
						...
						<li class="nav-item" onclick="location.href='/logout.members'">
							<div>
								<i class="fa-solid fa-comment-dots"></i>
							</div>
							<div class="naviBtn">Sign-Out</div>
						</li>
					</c:if>
					
					<c:if test="${WolfID == null}">
						<li class="nav-item" onclick="location.href='/views/members/login.jsp'">
							<div>
								<i class="fa-solid fa-comment-dots"></i>
							</div>
							<div class="naviBtn">Sign-In</div>
						</li>
						<li class="nav-item" onclick="location.href='/views/members/signup.jsp'">
							<div>
								<i class="fa-solid fa-comment-dots"></i>
							</div>
							<div class="naviBtn">Sign-Up</div>
						</li>
					</c:if>
